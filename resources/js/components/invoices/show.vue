<template>
    <div class="container">
        ...
        <div class="table invoice">
            <div class="logo">
                <img src="../../../../public/images/logo.png" alt="" style="width: 200px;">
            </div>
            ...
            <div class="invoice__header--item">
                <div>
                    <h2>Invoice To:</h2>
                    <!-- <p>{{ form.customer.firstname ? form.customer.firstname : '' }}</p> -->
                    <p>{{ customer }}</p>
                </div>
                <div>
            ...
            <div class="table py1">
                ...
                <!-- item 1 -->
                <div v-for="(item, i) in form.invoice_items" :key="item.id" class="table--items3">
                    <p>{{ i+1 }}</p>
